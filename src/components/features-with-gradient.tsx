...
const features = [
  ...
  },
  {
    ...
    description:
      "Join regular monthly meetups, community, and conferences to connect with fellow Bitcoin enthusiasts.",
  },
  {
  ...
  {
    icon: <Bitcoin className="h-10 w-10 text-bitcoin" size={40} />,
